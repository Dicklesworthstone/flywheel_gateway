...
if (isPlaywright) {
  test.describe("Setup - Page Display", () => {
    ...
    test("should display setup subtitle", async ({ page }) => {
      ...
      await expect(subtitle).toContainText("Configure your development environment");
    });
  ...
  test.describe("Setup - Step Navigation", () => {
    ...
    test("should navigate to install step when clicking Continue", async ({ page }) => {
    ...
    test("should navigate back from install to detect step", async ({ page }) => {
    ...
    test("should allow direct navigation to steps via step buttons", async ({ page }) => {
  ...
  test.describe("Setup - Detect Step Content", () => {
    ...
    test("should display Setup Status card with readiness", async ({ page }) => {
  ...
  test.describe("Setup - Priority Badges", () => {
    ...
    test("should display recommended badge with amber styling", async ({ page }) => {
    ...
    test("should display optional badge with slate styling", async ({ page }) => {
  ...
  test.describe("Setup - Install Step Content", () => {
    ...
    test("should display Already Installed section when tools are present", async ({ page }) => {
    ...
    test("should show install buttons for missing non-agent tools", async ({ page }) => {
  ...
  test.describe("Setup - Install Confirmation Modal", () => {
    ...
    test("should show confirmation modal when clicking install button", async ({ page }) => {
  ...
  test.describe("Setup - Verify Step Content", () => {
    ...
    test("should display setup complete or incomplete message", async ({ page }) => {
  ...
  test.describe("Setup - Recommendations Panel", () => {
    ...
    test("should display Recommendations card or All systems ready", async ({ page }) => {
    ...
    test("should show recommendation count in pill when present", async ({ page }) => {
      const recsHeader = page.locator("h3").filter({ hasText: "Recommendations" });
  ...
  test.describe("Setup - Tool Card Details", () => {
    ...
    test("should show authentication status when applicable", async ({ page }) => {
  ...
  test.describe("Setup - Step Completion Indicators", () => {
    ...
    test("should mark detect step as completed after initial load", async ({ page }) => {
    ...
    test("should track completed steps as user progresses", async ({ page }) => {
  ...
  test.describe("Setup - Network Logging", () => {
    ...
    test("should log install API requests when triggering install", async ({ page }) => {
      const requests: string[] = [];
